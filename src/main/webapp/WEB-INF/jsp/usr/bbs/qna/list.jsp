...
//]]>
    ...
    <div class="bbs_search">
        <form name="bbsNttSearchForm" id="bbsNttSearch" action="./selectBbsNttList.do" method="get" class="boardSearchForm">
			...
			<label for="searchCnd" class="skip">Select Search Category</label>
            <select name="searchCnd" id="searchCnd" title="Select Search Category">
				<option value="SJ" >Title</option>
				<option value="CN" >Content</option>
            </select>
            <label for="searchKrwd" class="skip">Enter Search Keyword</label>
            <input name="searchKrwd" id="searchKrwd" type="text" class="input_text" title="Enter Search Keyword" placeholder="Enter Search Keyword" value="" />
    ...
    <div class="bbs_info clearfix">
        <div class="bbs_left bbs_count">
            <span>Total  <strong>12</strong> posts</span>,
            <span class="division_line">Page <strong>1</strong> / 2</span>
        </div>
    </div>
