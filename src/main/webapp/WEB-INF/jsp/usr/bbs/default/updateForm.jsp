...
//]]>
	  ...
	  function fn_egov_deleteFile(atchFileIdx,returnUrl){
	  	...
	  	$("#fileForm").attr("action", "/hoeamsaji/board/deleteFile.do");
	  	$("#fileForm").submit();
...
<form name="bbsNttForm" id="bbsNtt" method="post" action="/hoeamsaji/usr/bbs/review/updateForm.do?menuId=${menuId }" onsubmit="return fn_validatorBbsNtt(this)" enctype="multipart/form-data">
<fieldset>
...
<p class="write_guide">글 작성시 <span class="exactly y">필수</span> 표시된 항목은 꼭 기재해 주세요</p>
	...
	<div class="bbs_btn_wrap clearfix">
        <div class="bbs_center">
            ...
            <a href="/hoeamsaji/usr/bbs/review/list.do?menuId=${menuId }" class="bbs_btn"><i class="icon"></i><span>목록</span></a>
        </div>
    </div>
