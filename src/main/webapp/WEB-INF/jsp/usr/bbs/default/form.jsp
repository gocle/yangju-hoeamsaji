...
<form name="bbsNttForm" id="bbsNtt" method="post" action="/hoeamsaji/usr/bbs/review/form.do" onsubmit="return fn_validatorBbsNtt(this)" enctype="multipart/form-data">
<fieldset>
...
<p class="write_guide">Fields marked with <span class="exactly y">Required</span> must be completed.</p>
	<table class="bbs_default write">
		<caption>Write a Review Post - Title, Author, Content, File Upload</caption>
        <tbody>

		<tr>
			<th scope="row"><label for="baTitle">Title</label> <span class="exactly y">Required</span></th>
			<td class="subject"><input type="text" name="baTitle" id="baTitle" style="width:540px;" value=""/></td>
		</tr>
	

		<tr>
			<th scope="row"><label for="memName">Author</label> <span class="exactly y">Required</span></th>
			<td>
		...
		<tr>
			<th scope="row"><label for="baContentHtml">Content</label> <span class="exactly y">Required</span></th>
			<td>
		...
		<tr>
			<th scope="row">Attachments <span class="exactly"></span>
				...
				<ul class="attach">
					<li>
						<div class="attach_file">
							<label for="atchmnfl_0" class="file_label">Attachment File_0</label>
							<span class="file_input"><input type="file" name="file_atchFileId" id="file_atchFileId1" class="file" /></span>
						</div>
						<div class="attach_alt">
							<label for="replcText_0" class="alt_label">Alternative Text for Attachment File_0</label>
							<span class="alt_input"><input type="text" name="replcText" id="replcText_0" placeholder="Enter alternative text for the attached image"  /></span>
						</div>
					</li>
					<li>
						<div class="attach_file">
							<label for="atchmnfl_1" class="file_label">Attachment File_1</label>
							<span class="file_input"><input type="file" name="file_atchFileId" id="file_atchFileId2" class="file" /></span>
						</div>
						<div class="attach_alt">
							<label for="replcText_1" class="alt_label">Alternative Text for Attachment File_1</label>
							<span class="alt_input"><input type="text" name="replcText" id="replcText_1" placeholder="Enter alternative text for the attached image"  /></span>
						</div>
					</li>
				</ul>
			</td>
	...
	<div class="bbs_btn_wrap clearfix">
        <div class="bbs_center">
			<input type="submit" value="Submit" class="bbs_btn write">
            <a href="/hoeamsaji/usr/bbs/review/list.do?menuId=${menuId }" class="bbs_btn"><i class="icon"></i><span>Back to List</span></a>
        </div>
    </div>
