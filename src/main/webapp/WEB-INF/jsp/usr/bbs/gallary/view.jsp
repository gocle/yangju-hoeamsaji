...
<c:import url="/usr/layout/top.do" />
  ...
  <c:import url="/usr/menu/header.do" />
  	 <link rel="stylesheet" type="text/css" href="<c:url value='/ckeditor/user-contents.css'/>">
     ...
     function fn_update(baId,menuId) {
  	   var url = "/hoeamsaji/usr/bbs/${bcId}/updateForm.do?menuId="+menuId+"&baId=" + baId;
  	   location.href = url;
     }
     
     function fn_delete() {
  		  var url = "/hoeamsaji/usr/bbs/${bcId}/delete.do";
