                ...
                <div class="sub-inner">
                    ...
                    <div class="sub-intro-content">
                        ...
                        <div class="sub-summary-list">
                            <article>
                                <i class="sub-icon sub-icon-01"></i>
                                <strong>Period</strong>
                                <p>Late Goryeo – Early Joseon</p>
                            </article>
                            ...
                            <article>
                                <i class="sub-icon sub-icon-03"></i>
                                <strong>Designated Zone</strong>
                                <p>33,391㎡</p>
                            </article>

                            <article>
                                <i class="sub-icon sub-icon-04"></i>
                                <strong>Protection Zone</strong>
                                <p>323,117㎡</p>
                            </article>
                        </div>
