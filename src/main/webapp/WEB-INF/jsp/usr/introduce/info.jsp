            ...
            <section class="sub-visual section-rise">
                ...
                <div class="sub-visual__content">
                    ...
                    <div class="sub-location"> 
                        ...
                        <span>Hoeamsaji</span>
                        <span>Excavation and restoration</span>
                    </div>
                </div>
                ...
                <div class="sub-inner">
                    ...
                    <div class="excavation-panel">
                        ...
                        <div class="excavation-map">
                            <img src="/hoeamsaji/assets/site/hoeamsaji/img/excavation-map.png" alt="Excavation Survey Map">

                            <div class="excavation-floating excavation-floating--left">
                                <article class="excavation-card excavation-card-01 js-rise-card delay-1">
                                ...
                                <article class="excavation-card js-rise-card delay-2">
                                    <div class="excavation-card-head">
                                ...
                                <article class="excavation-card excavation-card-03 js-rise-card delay-3">
                                    <div class="excavation-card-head">
                            ...
                            <div class="excavation-floating excavation-floating--right">
                                <article class="excavation-card js-rise-card delay-1">
                                    <div class="excavation-card-head">
                                ...
                                <article class="excavation-card excavation-card-05 js-rise-card delay-2">
                                    <div class="excavation-card-head">
                                    ...
                                    <img src="/hoeamsaji/assets/site/hoeamsaji/img/excavation-thumb05-1.jpg" alt="">
                                </article>

                                <article class="excavation-card js-rise-card delay-3">
                                    <div class="excavation-card-head">
                                        <span class="num num-06">06</span>
                                        <div class="excavation-card-title">
                                            <strong>Well Site</strong>
                                            <em>6th Excavation</em>
                                        </div>
                                    </div>
