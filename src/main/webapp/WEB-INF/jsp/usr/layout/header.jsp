		...
		<header id="header">
			...
			<div class="gnb">
				<div class="wrap">
					<div class="link">
						<ul class="link_list">
							<li><a href="https://www.yangju.go.kr/www/index.do" target="_blank" class="btn one-btn">양주시청 바로가기</a></li>
							<li><a href="https://edu.ingang.go.kr/NGLMS" target="_blank" class="btn">강남인강 바로가기</a></li>
							<c:choose>
								<c:when test="${not empty sessionScope.SESSION_DI_KEY}">						
									<li class="link_item logout"><a href="/hoeamsaji/usr/login/logout.do" class="link_anchor" title="로그아웃">로그아웃</a></li>
                            		<li class="link_item mypage"><a href="/hoeamsaji/usr/mypage/myReservation.do" class="link_anchor">나의예약</a></li>
								</c:when>
								<c:otherwise>
			...
			<div class="group">
				<div class="wrap">
					<div class="logo">
						<a href="/hoeamsaji/usr/main.do" class="logo_anchor"><img src="/hoeamsaji/assets/site/hoeamsaji/images/common/logo_new.png" alt="Yangju City Hoeamsaji Temple Site Museum"></a>
					</div>
				</div>
