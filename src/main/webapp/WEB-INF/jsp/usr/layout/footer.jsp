			...
			<div class="wrap">
				<div class="link">
					...
					<ul class="link_list">
						...
						<li class="link_item n6"><a href="/hoeamsaji/usr/menu/sitemap.do?key=4151" class="link_anchor">사이트맵</a></li>
					</ul>
				</div>
				...
				<div class="footer_content">
					<div class="info">
						<address>
							<span class="info_address">[11473] 경기도 양주시 옥정동로7나길 18(옥정동)드림타워 1 2층 211호 진로진학지원센터 </span>
							<span class="info_tel">대표전화 : 031-8082-7953~4 </span>
						</address>
						<p class="info_copyright">COPYRIGHT(C) Yangju OFFICE. All Rights Reserved.</p>
					</div>
				</div>
			</div>
		</footer>
