...
function fn_save(){
	...
	$("#form").attr("action", "/hoeamsaji/adm/company/insert.do");
...
function fn_update() {
	...
	$("#form").attr("action", "/hoeamsaji/adm/company/update.do");
	$("#form").attr("target","_self");
	$("#form").submit();
...
function fn_list() {
		...
		$("#searchform").attr("action", "/hoeamsaji/adm/company/list.do");
...
function fn_delete(){
	...
	$("#form").attr("action", "/hoeamsaji/adm/company/delete.do");
		...
		<form id="form" name="form" method="post"
			...
			<input type="hidden" name="menuId" id="menuId" value="${menuId }" />
				...
				<table class="detail" id="locationTable" style="width:50%;">
				  ...
				  <tbody>
				    ...
				    <tr>
					    ...
					    <input type="hidden" name="locId" value="${list.locId}">
					    <div>
						    <p>
								<button type="button" class="point" onclick="removeRow(this)"><i class="fa fa-remove"></i> 삭제</button>
				...
				function addHistoryRow() {
					...
					row += '<input type="hidden" name="locId" value="">';
					row += '	<div>';
					row += '		<p>';
