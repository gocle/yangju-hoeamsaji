package com.gocle.hoeamsaji.adm.login.web;
...
import com.gocle.hoeamsaji.adm.login.service.AdminLoginService;
import com.gocle.hoeamsaji.adm.login.vo.LoginVO;
import com.gocle.hoeamsaji.adm.member.service.AdminMemberService;
import com.gocle.hoeamsaji.adm.member.vo.MemberVO;
import com.gocle.hoeamsaji.comm.util.CommonUtil;
	...
	public String adminLogin(@RequestParam Map<String, Object> commandMap, HttpServletRequest request, RedirectAttributes redirectAttributes) throws Exception {
		...
		if (resultMap.get("LogonYn").equals("N")) {
			...
			if(!redirect_url.equals("")){
				 ...
				 nextUrl = "/adm/bbs/notice/list.do?menuId=2026MENU0000472";
			}
		} else {
			nextUrl = "/adm/loginPage.do";
			retMsg = (String) resultMap.get("LogonMsg");
