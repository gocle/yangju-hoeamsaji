package com.gocle.hoeamsaji.comm.util;
...
public class CommonUtil {
    ...
    @Value("${Globals.EncryptKey}")
    public void setEncryptKey(String key) {
    	CommonUtil.encryptKey = key;
    }
...
*/
	...
	*/
     ...
     * @return 변환된 String 값
     */
    public static String toDataStr( String data ) {
        String delim = ",";
        String arrStr = "";
        String str;
	...
	public static String initPassword(int size) {
		String result = "";
    ...
    */
	...
	public static String getEncryptPassword(String str) throws Exception{
	    if(str != null){
	...
	public static String getAesDecrypt(String text) throws Exception{
	        ...
	        byte[] results = cipher.doFinal(decodedBytes);
	...
	public static String getAesEncrypt(String text) throws Exception{
			String key = encryptKey;
	        Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
	        byte[] keyBytes= new byte[16];
	        byte[] b= key.getBytes("UTF-8");
