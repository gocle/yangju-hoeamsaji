package com.gocle.hoeamsaji.usr.login.web;
...
import com.gocle.hoeamsaji.usr.login.service.UserLoginService;
...
public class UserLoginController {
	...
	private static final String CALLBACK_URL = "/hoeamsaji/usr/login/successAuth.do";
